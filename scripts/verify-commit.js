 ...
 *   - 输入一些描述信息 .{1,50}
 */
const commitRE = /^(revert: )?(feat|fix|docs|style|refactor|perf|test|build|ci|chore|revert|merge)(\(.+\))?: .{1,50}/;
...
if (!commitRE.test(msg)) {
  ...
  console.error(
    `  ${chalk.bgRed.white(' ERROR ')} ${chalk.red(`Invalid commit message format.`)}\n\n` +
      ...
      `  ${chalk.green(`  - type must be one of [feat, fix, docs, style, refactor, perf, test, build, ci, chore, revert, merge]`)}\n` +
